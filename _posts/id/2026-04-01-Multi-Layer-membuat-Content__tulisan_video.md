---
ref: Multi-Layer-membuat-Content__tulisan_video
judul: 'Multi Layer saat membuat Content {tulisan, video, ...}'
title: 'Multi Layer saat membuat Content {tulisan, video, ...}'
description: ''
tags: [idea]
category: Idea
category_url: idea
...
Saya baru sadar, ternyata membuat Content berupa tulisan == tidak semudah yang saya bayangkan.<br/>
Walaupun semua tulisan di website ini, saya tulis untuk diri saya sendiri {seperti pada artikel [Menulis untuk 'Future of Me'](/id/Menulis-untuk-Future-of-Me/)}, tetapi tetap saja:
...
jika semua ditulis dengan cara yang berantakan ?<br/>
...
Oh iya, apa itu _Jekyll / GitHub Pages_ + implementasi di Website ini, dijelaskan pada artikel [ini](/id/SoftwareDevelopeRx-com-GitHub-Pages-site-Jekyll/)
